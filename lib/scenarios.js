...
export const MOTIONS = {
  legacyDisplacement: {
    ...
    challenge: "Use the four questions below to prepare a point of view for the decision-maker.",
    inputLayout: "three-col-plus-one",
    frameworkCards: [
    ...
    wobble: {
      type: "text",
      title: "The CFO just pushed back",
      description: "The CFO has raised a major objection to moving forward. She's worried about operational disruption during a board-sensitive quarter and suggested the investment be pushed to next FY. Your champion is asking for language she can take back to the exec team inside 48 hours.",
      question: "How do you keep the deal alive without losing credibility with the CFO?",
      scoringCriteria: [
        { name: "Objection Handling", weight: 40, description: "Does the response meet the CFO's concern head-on with business-grade logic?", poor: "Dismisses the objection or promises 'we'll figure it out.'", champion: "Reframes the CFO's risk into the cost of waiting, with specific time-value logic." },
        { name: "Executive Repositioning", weight: 30, description: "Does the response give the champion boardroom-ready language?", poor: "Hand-wavy reassurance that won't survive an exec review.", champion: "Three to five crisp lines the champion can paste into an email to the CFO." },
        { name: "Timeline Protection", weight: 30, description: "Does the response protect the original timing without appearing pushy?", poor: "Accepts the delay or escalates unprofessionally.", champion: "A measured counter-proposal that preserves momentum and gives the CFO a face-saving path." },
      ],
    },
  },
  ...
  replacement: {
    ...
    challenge: "Identify the status-quo biases holding this decision back. For each, surface the unconsidered risks and how you'd diagnose or prove them.",
    inputLayout: "bias-table",
    // Bias table — used when inputLayout is "bias-table"
    biases: [
      { id: "b1", statement: "A global platform migration is too disruptive." },
      { id: "b2", statement: "Every new platform deployment runs over budget — it's going to be too expensive." },
      { id: "b3", statement: "It will be too hard to get everyone aligned — executive team, IT, regional leaders, etc." },
      { id: "b4", statement: "The incumbent is working and they're continuously bringing new ideas. Why change?" },
    ],
    optionalBias: { id: "b5", label: "Optional: Identify another status quo bias not listed above" },
    // Keep framework cards for scoring rubric compatibility and scoring the submission as a whole
    frameworkCards: [
    ...
    wobble: {
      type: "choice",
      title: "The incumbent just dropped the price",
      description: "The incumbent vendor has offered a 30% discount and a two-year price lock to keep the business. The decision committee is reconvening in 72 hours. One committee member has privately signaled she's leaning toward the incumbent for 'risk reasons.'",
      prompt: "What's your next move in the next 72 hours?",
      options: [
        {
          id: "A",
          text: "Match the discount and add roadmap commitments.",
          detail: "Go to procurement with a 25% counter and sweetener package. Protect the deal at a lower margin.",
          points: 30,
        },
        {
          id: "B",
          text: "Reframe the decision before the committee reconvenes.",
          detail: "Request a 30-minute executive session. Bring a one-page business case that moves the conversation from price to lifetime value and switching risk.",
          points: 92,
        },
        {
          id: "C",
          text: "Escalate to the CEO-level sponsor.",
          detail: "Ask your exec sponsor to recommit to the evaluation criteria. Let the committee feel the air cover without changing the math.",
          points: 72,
        },
        {
          id: "D",
          text: "Defend the price via email and comparison sheet.",
          detail: "Send a well-constructed written response with feature/function comparisons and pricing justification.",
          points: 18,
        },
      ],
      scoringCopy: {
        A: "Matching price buys short-term safety but cedes the narrative. The CFO now thinks this was always negotiable — every renewal starts from here. You also signaled that the only thing that separated you from the incumbent was price.",
        B: "This is the move. You pull the decision back to your terms, the committee gets ammunition to defend the choice, and the incumbent's discount becomes a footnote. Executive-grade counter to a classic price play.",
        C: "Solid — exec sponsorship gives the committee cover. Just don't let it substitute for the business-case work. The best version of this move pairs the sponsor escalation WITH a committee-ready artifact.",
        D: "Price-vs-price debates are debates the incumbent wins. You need to change the frame, not argue within it. A written comparison sheet is what the committee would expect from a scared vendor, not a trusted advisor.",
      },
    },
  },
  ...
  defense: {
    ...
    challenge: "Build the defense plan. Address what we say, what the attacker says, and our next moves in the next 30 days.",
    inputLayout: "stacked-questions",
    // Stacked questions — used when inputLayout is "stacked-questions"
    questions: [
      { id: "q1", label: "What messages reinforce and differentiate our position?", placeholder: "Draft the key messaging points that elevate your value proposition and differentiate from the attacker…" },
      { id: "q2", label: "How could the competitor position against us? How can we proactively address these?", placeholder: "Anticipate the competitor's narrative and prepare counterpoints the new exec will find credible…" },
      { id: "q3", label: "What 2-3 actions can we take in the next 30 days to drive this strategy?", placeholder: "List specific, actionable steps with clear ownership and timing…" },
      { id: "q4", label: "What other information do we need to determine the right strategy?", placeholder: "Identify gaps in our knowledge and how to fill them…" },
    ],
    frameworkCards: [
    ...
    wobble: {
      type: "ranking",
      title: "A new executive wants a consolidation review",
      description: "A new senior executive has announced a platform consolidation review that puts your contract in play for elimination. A competing platform has been aggressively pitching the new exec. Your long-time champion has gone quiet in the last two weeks.",
      prompt: "Rank the four moves from first to last. What order gives you the best chance to save the account?",
      options: [
        {
          id: "A",
          text: "Business review with the new exec",
          detail: "90-minute data-led session. Impact delivered, forward outcomes, ROI model.",
        },
        {
          id: "B",
          text: "Rebuild the champion relationship",
          detail: "Coffee with your long-time champion. Understand what's changed, recruit her back.",
        },
        {
          id: "C",
          text: "Offer a commercial restructure",
          detail: "Lower the cost in exchange for a multi-year commitment and signed expansion tier.",
        },
        {
          id: "D",
          text: "Run a competitive differentiation session",
          detail: "Head-to-head against the challenger. Lean into unique capabilities the new exec cares about.",
        },
      ],
      // Pre-computed scores for possible ranking orders
      // The ideal order is A → B → D → C (engage new exec first, then champion, then differentiate, then commercial)
      idealOrder: ["A", "B", "D", "C"],
      rankingScores: {
        "A,B,D,C": 95, // perfect — new exec first, then champion, then differentiation, commercial last
        "A,B,C,D": 78,
        "A,D,B,C": 72,
        "B,A,D,C": 70,
        "B,A,C,D": 60,
        ...
        "D,A,B,C": 48,
        "B,D,A,C": 42,
        "C,A,B,D": 28, // commercial first = premature concession
        "D,B,A,C": 35,
        "C,B,A,D": 22,
        "C,D,A,B": 18,
        "D,C,A,B": 15,
      },
      defaultScore: 40, // used for any ranking not in the table
      scoringCopy: {
        excellent: "You led with the new exec, then pulled your champion back in, then differentiated, and left commercial as a closing tool. That's the textbook order — earn the strategic credibility, rebuild the coalition, then fight on your wedges, and let the commercial be the last tool out of the bag.",
        good: "Solid read of the political dynamics. You had the right instincts about where to start. The sequencing just slightly undervalues the new exec relationship or overvalues the commercial lever.",
        average: "You're in the right neighborhood but the order gives away leverage. Commercial or differentiation too early signals you don't have a strategic case — you're negotiating.",
        poor: "Leading with commercial or purely defensive moves tells the new exec you're panicking. The best vendors in this moment look LESS hungry, not more.",
      },
    },
  },
  ...
  expansion: {
    ...
    challenge: "Review the deal assessment below. For items marked \"No\", define the Next Actions your team would take to address the gap.",
    inputLayout: "deal-review",
    // Deal review framework — used when inputLayout is "deal-review"
    dealReview: {
      sections: [
        {
          name: "Value Alignment",
          items: [
            { id: "va1", criteria: "Business decision-makers have a defined transformation vision (including CX, AI, digital) that we can attach our solutions to.", status: "yes", evidence: "Leadership has formally proposed a standardization initiative. CEO/CFO have mandated enterprise evaluation tied to AI and data strategy." },
            { id: "va2", criteria: "Key leaders across divisions see us as a transformation partner, not just a vendor.", status: "no", evidence: "We are viewed as a successful regional solution, but have limited direct exposure to CIO/CFO across other divisions." },
            { id: "va3", criteria: "We have identified key business KPIs (e.g., customer growth, cost to serve, speed to market) we can attach our value to.", status: "yes", evidence: "Regional productivity gains can be leveraged across divisions — needs to be translated to a global or by-division business case." },
            { id: "va4", criteria: "We have demonstrated technical excellence to meet the customer's requirements and have translated into business outcomes.", status: "no", evidence: "Platform stable in one region. Pilot running in second. Unclear in the remaining divisions." },
          ],
        },
        {
          name: "Value Discovery",
          items: [
            { id: "vd1", criteria: "We have brought insights based on our incumbency or market experience to help the customer see what they haven't.", status: "no", evidence: "Initial conversations with VP of Data Science and AI have signaled shift to a global approach, but concerns about migration risks persist." },
            { id: "vd2", criteria: "We have uncovered current-state gaps in CX / operations / experience — beyond the obvious metrics.", status: "no", evidence: "Likely inconsistent employee and customer experience across divisions. Haven't explicitly identified the gaps globally." },
            { id: "vd3", criteria: "We are partnering with a champion to build stakeholder alignment around value opportunities and challenges.", status: "yes", evidence: "We have strong sponsors in the original division's leadership and in the global function. Must activate influence on the global approach." },
            { id: "vd4", criteria: "We have validated the urgency for transformation across key business decision-makers.", status: "yes", evidence: "CIO/CFO evaluation underway. Various divisions are looking to optimize / improve current approach." },
          ],
        },
        {
          name: "Value Story",
          items: [
            { id: "vs1", criteria: "Our co-created business case shows how our platform can influence business outcomes (e.g., cost reduction, customer satisfaction) at enterprise scale.", status: "no", evidence: "A divisional success story exists, but hasn't been translated into enterprise cost / risk / impact model." },
            { id: "vs2", criteria: "Our investment positioning and pricing strategy clearly aligns to decision-makers' views of value.", status: "no", evidence: "Must fully map global and regional decision-makers — influence and view of value." },
            { id: "vs3", criteria: "Our champion and decision-makers can confidently articulate our value in business terms — emphasizing 'why us' and 'why now.'", status: "no", evidence: "Division and function leaders are strong supporters, but need to engage other stakeholders, particularly CIO and CFO." },
            { id: "vs4", criteria: "We are achieving the time-bound milestones of our joint success plan (including technical, procurement, legal approvals).", status: "no", evidence: "No agreed global sequencing or decision gates yet; divisions still operating independently." },
          ],
        },
      ],
      placeholderIfNo: "Define actions to address this gap…",
    },
    frameworkCards: [
    ...
    wobble: {
      type: "multi-select",
      title: "Procurement wants to centralize",
      description: "Procurement has launched a 'vendor rationalization' initiative that would consolidate all departmental platforms under a single enterprise agreement. Your expansion opportunity is now caught in the review. A competitor with existing enterprise contracts is positioned to absorb the work.",
      prompt: "Pick the TWO moves that give you the best shot at turning procurement's consolidation into your expansion.",
      maxSelections: 2,
      options: [
        {
          id: "A",
          text: "Reposition your expansion AS the consolidation solution.",
          detail: "Lead with TCO reduction, vendor consolidation, and governance alignment — in procurement's language.",
        },
        {
          id: "B",
          text: "Cut price to undercut the competitor's enterprise contract.",
          detail: "Aggressive discount to force a procurement-level comparison on cost alone.",
        },
        {
          id: "C",
          text: "Bring your executive sponsor to the procurement review.",
          detail: "Level-match the competitor's enterprise relationship by showing up with executive presence of your own.",
        },
        {
          id: "D",
          text: "Strengthen the original business champion's position.",
          detail: "Arm your champion with the internal arguments she needs to defend the expansion inside her own org.",
        },
        {
          id: "E",
          text: "Walk away from expansion and protect existing footprint.",
          detail: "Sacrifice the expansion play to avoid getting rolled up in the consolidation review.",
        },
      ],
      // Pre-computed scores per pair
      multiSelectScores: {
        "A,C": 95, // perfect — narrative flip + executive matching
        "A,D": 85, // strong — narrative flip + champion support
        "C,D": 72, // good — coalition approach but lacks the narrative flip
        "A,B": 55, // mixed — right idea but price-cutting muddies the narrative
        "A,E": 45, // contradictory — reposition while retreating
        "B,C": 48, // price + exec, but no strategic frame
        "B,D": 42,
        "C,E": 35,
        "D,E": 28,
        "B,E": 18, // worst — cut price AND walk away
      },
      defaultScore: 40,
      scoringCopy: {
        excellent: "You led with the strategic reframe and brought the executive presence to match. That combination gives procurement a reason to see you as THE consolidation answer, not just another platform in the review.",
        good: "Right instincts. You're pulling the coalition together and giving procurement something to work with. The next level is pairing it with a harder strategic narrative flip so they don't default to the enterprise incumbent.",
        average: "Partial credit. One of your moves is moving the right direction but the other either contradicts it or undercuts the strategic case.",
        poor: "These moves either retreat from the opportunity or play the game on the incumbent's terms. Consolidation reviews are won by sellers who reframe what's being consolidated, not by sellers who underbid.",
      },
    },
  },
};
