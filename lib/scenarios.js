...
export const MOTIONS = {
  ...
  replacement: {
    ...
    wobble: {
      ...
      question: "How do you reframe the decision before the committee reconvenes?",
      scoringCriteria: [
        { name: "Counter-Move", weight: 40, description: "Does the response directly engage the price drop without matching it?", poor: "Matches the discount or dismisses the move entirely.", champion: "Neutralizes the price by reframing the cost of inaction and the cost of switching back later." },
        { name: "Value Reframe", weight: 30, description: "Does the response pull the decision back to business value?", poor: "Gets pulled into a price-vs-price debate.", champion: "Makes price a line item in a larger ROI conversation the committee owns." },
        { name: "Decision Velocity", weight: 30, description: "Does the response make the committee's decision easier, not harder?", poor: "Introduces new information that would stall the decision.", champion: "Provides a simple three-bullet artifact the committee can paste into their decision memo." },
      ],
    },
  },
  ...
  defense: {
    ...
    wobble: {
      ...
      question: "How do you re-earn the relationship and keep the renewal?",
      scoringCriteria: [
        { name: "Re-engagement", weight: 40, description: "Does the response re-earn the champion while engaging the new exec?", poor: "Hides from the risk or relies on the old champion alone.", champion: "A concrete plan to re-engage the champion while building a direct track with the new exec." },
        { name: "Political Read", weight: 30, description: "Does the response accurately read the new exec's position and motivations?", poor: "Assumes the new exec thinks like the previous one.", champion: "Articulates what the new exec cares about and how your platform maps to it." },
        { name: "Forward Case", weight: 30, description: "Does the response offer the new regime something they want?", poor: "Defensive posture focused only on protecting status quo.", champion: "A forward-facing expansion or efficiency pitch the new exec can champion as her own win." },
      ],
    },
  },
  ...
  expansion: {
    ...
    wobble: {
      ...
      question: "How do you turn procurement's consolidation play into your expansion moment?",
      scoringCriteria: [
        { name: "Narrative Flip", weight: 40, description: "Can the response reposition your expansion AS the consolidation solution?", poor: "Treats procurement as an obstacle to work around.", champion: "Makes the case that your expansion plan IS the rationalization play procurement is looking for." },
        { name: "Enterprise Reframing", weight: 30, description: "Does the response speak procurement's language — TCO, standardization, governance?", poor: "Business-buyer framing that doesn't resonate with procurement.", champion: "A procurement-ready narrative about TCO reduction, vendor consolidation, and governance alignment." },
        { name: "Coalition Building", weight: 30, description: "Does the response bring new allies to the table?", poor: "Relies solely on the original champion.", champion: "A multi-stakeholder coalition — including procurement — pulling in one direction." },
      ],
    },
  },
};
